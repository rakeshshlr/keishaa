...
function preload(){
  covidImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/covid.png");
  resetImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/restarting.png");
  prec1= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/pre1.png");
  prec2= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/pre2.png");
  prec3= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/pre3.png");
  prec4= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/pre4.png");
  heartImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/heart.png");
  bgImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/bground.png");
  footpathImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/footpath.jpeg");
  bushImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/bush.png");
  treeImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/tree.png");
  benchImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/bench.png");
  startImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/StartBg.jpg");
  startButton= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/start.png");
  endImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/end.jpg");
  cloudImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/cloud.png");
  pauseImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/pause.png");
  restartPImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/restarting.png");
  resumeImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/resume.png");
  homeImg= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/home.png");
  boyStart= loadImage("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy.png");
  runningBoy= loadAnimation("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy1.png","https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy2.png","https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy3.png","https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy4.png","https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy5.png","https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy6.png","https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy7.png","https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/boy8.png");
  bgSound= loadSound("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/bgmusic.mp3");
  collect= loadSound("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/life.mp3");
  die= loadSound("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/die.mp3");
  bang= loadSound("https://curriculum-project-images.s3.ap-south-1.amazonaws.com/PRO/bang.mp3");
}
